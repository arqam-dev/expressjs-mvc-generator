...
function createApplication(name, dir) {
  ...
  // App.js file
  copyTemplateMulti('js/app_file', dir + '/', '*.js')
  ...
  mkdir(dir, '__tests__')
  copyTemplateMulti('js/readme_acceptance', dir + '/__tests__/', '*.md')
  mkdir(dir, '__tests__/acceptance')
  copyTemplateMulti('js/acceptance', dir + '/__tests__/acceptance/', '*.js')

  mkdir(dir, 'api')
  mkdir(dir, 'api/v1')

  // copy controller templates
  mkdir(dir, 'api/v1/controller')
  copyTemplateMulti('js/controllers', dir + '/api/v1/controller', '*.js')

  // copy route templates
  mkdir(dir, 'api/v1/routes')
  copyTemplateMulti('js/routes', dir + '/api/v1/routes', '*.js')
  ...
  // copy javascripts templates
  mkdir(dir, 'public/javascripts')
  mkdir(dir, 'public/javascripts/responses')
  copyTemplateMulti('js/responses', dir + '/public/javascripts/responses', '*.json')
  copyTemplateMulti('js/consolelog', dir + '/public/javascripts/', '*.js')

  mkdir(dir, 'public/images')
  mkdir(dir, 'public/stylesheets')

  // copy repositories templates
  mkdir(dir, 'repositories')
  copyTemplateMulti('js/repositories', dir + '/repositories', '*.js')

  mkdir(dir, 'server')
  mkdir(dir, 'server/boot')
  copyTemplateMulti('js/server/boot', dir + '/server/boot', '*.js')

  mkdir(dir, 'server/config')
  copyTemplateMulti('js/server/config', dir + '/server/config', '*.json')

  mkdir(dir, 'server/middlewares')
  copyTemplateMulti('js/server/middlewares', dir + '/server/middlewares', '*.js')

  mkdir(dir, 'server/scripts')

  mkdir(dir, 'services')
  copyTemplateMulti('js/services', dir + '/services', '*.js')

  copyTemplateMulti('js/help', dir + '/', '*.md')

  copyTemplateMulti('js/env', dir + '/', '.*')
  copyTemplateMulti('js/gitignore_file', dir + '/', '.*')
  copyTemplateMulti('js/swagger', dir + '/', '*.json')
  ...
  copyTemplateMulti('js/packagefiles', dir + '/', '*.json')
